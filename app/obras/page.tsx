  ...
  return (
    <main className="overflow-hidden bg-[#f8f1ea] text-[#171313]">
      <section className="relative px-5 pb-12 pt-36 sm:px-8 lg:px-14 lg:pb-16">
        <div className="absolute inset-0 bg-[url('/images/textures/fondo.jpg')] bg-cover opacity-[0.11]" />
        ...
        <div className="relative mx-auto max-w-[1180px] text-center">
          ...
          <h1 className="mt-7 font-serif text-[58px] font-normal leading-none sm:text-[92px]">Catálogo de obras</h1>
